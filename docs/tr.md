...
4. **Поиск фильмов по названию, жанру, году**
5. **Просмотр информации о фильме**
6. **Выставление оценок фильмам (1-5 звезд)**
7. **Получение персональных рекомендаций**
8. **Социальная лента с активностью друзей**
9. **Уведомления о новых событиях**
...
### 5. Просмотр социальной ленты

**Предусловия:** Пользователь авторизован и имеет друзей

**Основной поток:**
1. Пользователь переходит на страницу ленты
2. Система показывает последние активности друзей (оценки фильмов, отзывы)
3. Пользователь может фильтровать ленту по друзьям или по времени
...
- Реализация системы друзей и ленты активностей
