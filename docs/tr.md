...
4. Пользователь вводит код, который приходит на почту
...
**Основной поток:**
1. Пользователь ищет другого пользователя по логину
...
**Основной поток:**
1. Пользователь ищет фильм по названию
2. Система возвращает фильм
...
- **Подтверждение почты** для безопасности
---
...
- **Просмотр информации о фильмах** (основные данные)
- **Система оценок** (1-5 звезд + отзыв)
